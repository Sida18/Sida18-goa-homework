...
alert(`i want to traval ${Number(myAge+future)} my dad and mom wants to traval ${Number(myMothersAge+future)} and ${Number(myFathersAge+future)}  my sibling's want to traval ${Number(MySistersAge+future)} and ${Number(MyBrothersAge+future)} years`)
